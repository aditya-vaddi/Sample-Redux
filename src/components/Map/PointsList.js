              ...
              <ScrollView style={styles.container}>
                  {/*   <Image source = {{uri:this.props.image}} style={{height:height/3,width:width,backgroundColor:'yellow'}}/> */}
                    <View style={{height:height/3,width:width,alignItems:'center',justifyContent:'center'}}>
                        ...
                        <Text style={{fontFamily:'AvenirNext-bold',color:'#ffffff',opacity:0.5}}>No Areas Drawn</Text>
                    </View>
              </ScrollView>
          )
      if(1)
          return (
                <ScrollView style={styles.container}>
                  {/*  <Image source = {{uri:this.props.image}} style={{height:height/3,width:width,backgroundColor:'yellow'}}/> */}
                      <View style={{height:50,backgroundColor:'#1E88E5',alignItems:'center',justifyContent:'center'}}>
                          <Text style={{fontFamily:'AvenirNext-bold',color:'#ffffff',fontSize:20}}>Coordinate Count: {this.props.points.data.coordinates.length}</Text>
                      </View>
